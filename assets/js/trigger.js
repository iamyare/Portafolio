...
(() => {
	...
	var bi = s(() => {
		window.tram = (function (e) {
			...
			function i(c, p, h) {
				return "#" + ((1 << 24) | (c << 16) | (p << 8) | h).toString(16).slice(1);
			}
			function o() {}
			function a(c, p) {
			...
			var d = (function (c, p, h) {
					...
					function V(H, oe) {
						...
						return (
							...
							(F.open = function (Ie) {
								if (((Z = {}), w(Ie) ? (Z = Ie.call(F, je, le, F, H)) : y(Ie) && (Z = Ie), y(Z)))
				...
				E = {
					ease: [
						...
						function (c, p, h, y) {
							var w = (c /= y) * c,
								m = w * c;
							return p + h * (-2.75 * m * w + 11 * w * w + -15.5 * m + 8 * w + 0.25 * c);
						},
					],
					"ease-in": [
						"ease-in",
					...
					"ease-out": [
						...
						function (c, p, h, y) {
							var w = (c /= y) * c,
								m = w * c;
							return p + h * (0.3 * m * w + -1.6 * w * w + 2.2 * m + -1.8 * w + 1.9 * c);
						},
					],
					"ease-in-out": [
						"ease-in-out",
					...
					"ease-in-out-quad": [
						...
						function (c, p, h, y) {
							return (c /= y / 2) < 1 ? (h / 2) * c * c + p : (-h / 2) * (--c * (c - 2) - 1) + p;
						},
					],
					"ease-in-cubic": [
					...
					"ease-out-expo": [
						...
						function (c, p, h, y) {
							return c === y ? p + h : h * (-Math.pow(2, (-10 * c) / y) + 1) + p;
						},
					],
					"ease-in-out-expo": [
					...
					"ease-in-back": [
						...
						function (c, p, h, y, w) {
							return w === void 0 && (w = 1.70158), h * (c /= y) * c * ((w + 1) * c - w) + p;
						},
					],
					"ease-out-back": [
						...
						function (c, p, h, y, w) {
							return (
								w === void 0 && (w = 1.70158), h * ((c = c / y - 1) * c * ((w + 1) * c + w) + 1) + p
							);
						},
					],
					"ease-in-out-back": [
				...
				x = function (c) {
					...
					var p,
						...
						y = "",
						w = c.split("-");
					for (p = 0; p < w.length; p++) y += w[p].charAt(0).toUpperCase() + w[p].slice(1);
					for (p = 0; p < _.length; p++)
						if (((h = _[p] + y), h in P.style)) return { dom: h, css: L[p] + c };
				},
				D = (t.support = {
			...
			if (D.transition) {
				var B = D.timing.dom;
				if (((P.style[B] = E["ease-in-back"][0]), !P.style[B])) for (var K in T) E[K][0] = T[K];
			}
			var ne = (t.frame = (function () {
				...
				He = d(function (c) {
					function p(U, J) {
						...
						if (!J.weak || !this.props[ee]) {
							var Me = Te[0],
								be = this.props[ee];
							return be || (be = this.props[ee] = new Me.Bare()), be.init(this.$el, se, Te, J), be;
						}
					}
					function h(U, J, se) {
						if (U) {
							...
							if (
								...
								return (
									(this.timer = new $r({ duration: U, context: this, complete: m })),
									void (this.active = !0)
								);
							if (ee == "string" && J) {
								switch (U) {
					...
					function w(U) {
						return this.active
							? (this.queue.push({ options: U, args: arguments }), void (this.timer.complete = m))
					...
					function le() {
						...
						for (U in this.props) (J = this.props[U]), J.active && se.push(J.string);
						(se = se.join(",")),
							this.style !== se && ((this.style = se), (this.el.style[D.transition.dom] = se));
					}
					function je(U, J, se) {
						var ee,
							Te,
						...
						for (ee in U)
							(Me = U[ee]),
								ee in ut
									? (fe.transform || (fe.transform = {}), (fe.transform[ee] = Me))
									: (A.test(ee) && (ee = r(ee)),
									  ee in Ai ? (fe[ee] = Me) : (be || (be = {}), (be[ee] = Me)));
						for (ee in fe) {
					...
					(c.init = function (U) {
						...
						D.backface && Ae.hideBackface && Lt(this.el, D.backface.css, "hidden");
					}),
						xe("add", p),
						xe("start", h),
						xe("wait", y),
				...
				Y = d(function (c) {
					...
					function y(m) {
						...
						return (V ? i(V[1], V[2], V[3]) : m).replace(/#(\w)(\w)(\w)$/, "#$1$1$2$2$3$3");
					}
							...
							switch (V) {
								...
								case C:
									if (F) {
										...
										if (V.test(m)) return m.charAt(0) == "#" && m.length == 7 ? m : y(m);
									}
									H = "hex or rgb string";
									break;
								case R:
				...
				fr = d(function (c) {
					...
					function h() {
						var F,
							...
							Z,
							le = H.length;
						if (le) for (ne(h), $ = Ne(), F = le; F--; ) (Z = H[F]), Z && Z.render($);
					}
					function y(F) {
						var $,
							Z = e.inArray(F, H);
						Z >= 0 && (($ = H.slice(Z + 1)), (H.length = Z), $.length && (H = H.concat($)));
					}
					function w(F) {
						return Math.round(F * oe) / oe;
					}
					function m(F, $, Z) {
						return i(F[0] + Z * ($[0] - F[0]), F[1] + Z * ($[1] - F[1]), F[2] + Z * ($[2] - F[2]));
					}
					...
					(c.init = function (F) {
						...
						(c.play = function () {
							this.active || (this.start || (this.start = Ne()), (this.active = !0), p(this));
						}),
						(c.stop = function () {
				...
				us = d(fr, function (c, p) {
					(c.init = function (h) {
						...
						(c.render = function (h) {
							...
							for (y = m; y--; )
								(w = this.tweens[y]),
									w.context && (w.render(h), (this.current[w.name] = w.value), (V = !0));
		...
		ds.exports = (function () {
					...
					e.forEach =
						function (_, L, x) {
							...
							if (v && _.forEach === v) _.forEach(L, x);
								...
								for (var D = 0, B = _.length; D < B; D++) if (L.call(x, _[D], D, _) === t) return;
							} else
			...
			(e.contains = e.include =
				...
				(e.debounce = function (_, L, x) {
					...
					return function () {
						...
						var ye = x && !D;
						return D || (D = setTimeout(He, L)), ye && ((Ne = _.apply(K, B)), (K = B = null)), Ne;
					};
				}),
			...
			return (
				(e.template = function (_, L, x) {
					...
					var D = RegExp(
							[(L.escape || G).source, (L.interpolate || G).source, (L.evaluate || G).source].join(
								"|"
							) + "|$",
							"g"
						),
...
`);
					var ne = L.variable;
					if (ne) {
						if (!P.test(ne)) throw new Error("variable is not a bare identifier: " + ne);
					} else
						(K =
							`with(obj||{}){
` +
...
` +
	...
	var bs = s((zU, As) => {
		...
		qi.define(
			...
			(As.exports = function (e, t, r) {
				if (((r = r || {}), (qi.env("test") || qi.env("frame")) && !r.fixture && !uI()))
					return { exit: 1 };
				var n = {},
					i = e(window),
				...
				function b(C, R) {
					e.ajax({ type: "GET", url: C, dataType: "script", cache: !0 }).then(R, S);
				}
				function S(C, R, N) {
					throw (console.error("Could not load editor script: " + R), N);
				}
				function q(C) {
					return C.indexOf("//") >= 0 ? C : O("https://editor-api.webflow.com" + C);
				}
				function O(C) {
				...
				function A(C) {
					...
					var N = function (M) {
						M.data === "WF_third_party_cookies_unsupported"
							? (g(R, N), C(!1))
							: M.data === "WF_third_party_cookies_supported" && (g(R, N), C(!0));
					};
					(R.onerror = function () {
						g(R, N), C(!1);
					}),
		...
		cI.define(
			...
			(Rs.exports = function () {
				function e(r) {
					...
					function A(g) {
						(g.target.nodeName && g.target.nodeName.toLowerCase() === "html") || ((n = !1), O());
					}
	...
	var xs = s((QU, Ps) => {
		...
		var Li = window.jQuery,
			...
			tn = {
				...
				intro: function (e, t) {
					t.__wf_intro || ((t.__wf_intro = !0), Li(t).triggerHandler(ke.types.INTRO));
				},
				outro: function (e, t) {
					t.__wf_intro && ((t.__wf_intro = null), Li(t).triggerHandler(ke.types.OUTRO));
				},
			};
		ke.triggers = {};
	...
	var Xs = s((JU, nt) => {
		...
		(nt.exports = xi), (nt.exports.__esModule = !0), (nt.exports.default = nt.exports);
	});
	var Mt = s((eB, pr) => {
		var dI = Xs().default;
		function Vs(e) {
		...
		function pI(e, t) {
			...
			if (e === null || (dI(e) !== "object" && typeof e != "function")) return { default: e };
			var r = Vs(t);
		...
		(pr.exports = pI), (pr.exports.__esModule = !0), (pr.exports.default = pr.exports);
	});
	var ze = s((tB, vr) => {
		function vI(e) {
			return e && e.__esModule ? e : { default: e };
		}
		(vr.exports = vI), (vr.exports.__esModule = !0), (vr.exports.default = vr.exports);
	});
	var ae = s((rB, Us) => {
		var nn = function (e) {
	...
	var gu = s((gB, _u) => {
		var hu = ae(),
			...
			Xe,
			an;
		Eu && ((Xe = Eu.split(".")), (an = Xe[0] > 0 && Xe[0] < 4 ? 1 : +(Xe[0] + Xe[1])));
		!an &&
			Ui &&
			((Xe = Ui.match(/Edge\/(\d+)/)),
			(!Xe || Xe[1] >= 74) && ((Xe = Ui.match(/Chrome\/(\d+)/)), Xe && (an = +Xe[1])));
		_u.exports = an;
	});
	var Bi = s((yB, Iu) => {
		var yu = gu(),
	...
	var $i = s((PB, ku) => {
		...
		ku.exports = function (e) {
			if (!Wu(Gt, e) || !(Hu || typeof Gt[e] == "string")) {
				var t = "Symbol." + e;
				Hu && Wu(Tt, e) ? (Gt[e] = Tt[e]) : Ku && ju ? (Gt[e] = ju(t)) : (Gt[e] = ET(t));
			}
			return Gt[e];
		};
	});
	var Qu = s((xB, $u) => {
		...
		$u.exports = function (e, t) {
			...
			var r = gT(e, OT),
				n;
			if (r) {
				if ((t === void 0 && (t = "default"), (n = _T(r, e, t)), !zu(n) || Yu(n))) return n;
	...
	var el = s((sW, Jc) => {
		...
		Jc.exports = function (e, t) {
			var r = e.target,
				...
				f,
				v;
			if ((n ? (a = _o) : i ? (a = _o[r] || sm(r, {})) : (a = (_o[r] || {}).prototype), a))
				for (u in t) {
					if (
						((f = t[u]),
	...
	var vl = s((fW, pl) => {
		var gm = gr(),
			...
			En = function () {
				...
				En = typeof document < "u" ? (document.domain && vn ? ll(vn) : Sm()) : ll(vn);
	...
	var dt = s((SW, Fl) => {
		...
		function Zm(e) {
			return e == null ? (e === void 0 ? Qm : $m) : Dl && Dl in Object(e) ? zm(e) : Ym(e);
		}
		Fl.exports = Zm;
	});
	var So = s((AW, Gl) => {
				...
				if (typeof r(void 0, { type: i }) > "u")
					throw new Error(
						'Reducer "' +
							...
							("Don't try to handle " + Yl.ActionTypes.INIT + ' or other actions in "redux/*" ') +
	...
	var nf = s((_n) => {
		...
		var eA = Xo(),
			...
			uA = { [tA]: !0, [rA]: !0, [nA]: !0, [iA]: !0, [oA]: !0, [aA]: !0, [sA]: !0 };
	...
	var Sr = s((zW, ot) => {
		...
		(ot.exports = Ho), (ot.exports.__esModule = !0), (ot.exports.default = ot.exports);
	});
	var Wt = s((ue) => {
		"use strict";
						...
						for (var d = 0; d <= v.length; d++) {
							...
							if (!(e && n[E] !== void 0)) {
								...
								t && In(n[E]) && In(T) && (T = we(e, t, n[E], T)),
									!(T === void 0 || T === n[E]) && (i || ((i = !0), (n = Tn(n))), (n[E] = T));
							}
						}
				}
			}
		...
		function Tf(e, t, r, n, i, o) {
			for (var a = arguments.length, u = Array(a > 6 ? a - 6 : 0), l = 6; l < a; l++)
				u[l - 6] = arguments[l];
			return u.length
		...
		function mf(e, t, r, n, i, o, a) {
			var u = On(e, t);
			u == null && (u = {});
			for (var l = void 0, f = arguments.length, v = Array(f > 7 ? f - 7 : 0), d = 7; d < f; d++)
				v[d - 7] = arguments[d];
			return (
				v.length
	...
	var Rd = s((b5, bd) => {
		...
		function xR() {
			(this.size = 0),
				(this.__data__ = { hash: new Ad(), map: new (PR || LR)(), string: new Ad() });
		}
		bd.exports = xR;
	});
	var Cd = s((R5, wd) => {
	...
	var Ud = s((x5, Vd) => {
		...
		function tw(e, t) {
			...
			if (r instanceof QR) {
				var n = r.__data__;
				if (!ZR || n.length < ew - 1) return n.push([e, t]), (this.size = ++r.size), this;
	...
	var xp = s((iH, Pp) => {
		var OC = dt(),
			...
			ie = {};
		ie[VC] = ie[UC] = ie[BC] = ie[WC] = ie[HC] = ie[jC] = ie[KC] = ie[kC] = ie[zC] = !0;
		ie[AC] =
			ie[bC] =
			ie[GC] =
			ie[RC] =
		...
		function MN(e, t, r, n, i, o) {
			...
			if (S && !q) {
				...
				C != R &&
					"constructor" in e &&
					"constructor" in t &&
					!(typeof C == "function" && C instanceof C && typeof R == "function" && R instanceof R) &&
					(S = !1);
			}
	...
	var Tv = s((IH, Iv) => {
		...
		function aq(e, t, r, n, i, o) {
			...
			if (E && !v)
				return o || (o = new ca()), a || nq(e) ? eq(e, t, r, n, i, o) : tq(e, t, l, r, n, i, o);
			if (!(r & iq)) {
	...
	var Vn = s((wH, xv) => {
		...
		function qq(e, t) {
			if (Rq(e)) return !1;
			var r = typeof e;
			return r == "number" || r == "symbol" || r == "boolean" || e == null || wq(e)
				? !0
	...
	var Fv = s((CH, Dv) => {
		...
		function pa(e, t) {
			if (typeof e != "function" || (t != null && typeof t != "function")) throw new TypeError(Lq);
			var r = function () {
				var n = arguments,
	...
	var iE = s((VH, nE) => {
		...
		function pL(e, t, r) {
			...
			return o || ++n != i
				? o
				: ((i = e == null ? 0 : e.length), !!i && fL(i) && lL(a, i) && (cL(e) || uL(e)));
		}
		nE.exports = pL;
	});
	var aE = s((UH, oE) => {
	...
	var Ia = s((ij, XE) => {
		...
		XE.exports = function (t, r, n, i) {
			...
			if (t !== r || n !== i) for (var a = 0; a < Dr; ++a) o[a] = zn(a * kn, t, n);
			function u(l) {
			...
			return function (f) {
				return t === r && n === i ? f : f === 0 ? 0 : f === 1 ? 1 : zn(u(f), r, i);
			};
		};
	});
	var Ta = s((j) => {
	...
	var HE = s((Zt) => {
				...
				switch (t.type) {
					...
					case Cx: {
						let { elementId: r, element: n, origin: i, actionItem: o, refType: a } = t.payload,
							{ actionTypeId: u } = o,
							l = e;
						return (0, $n.getIn)(l, [r, n]) !== n && (l = WE(l, n, a, r, o)), Sa(l, r, u, i, o);
					}
					case Nx: {
		...
		function WE(e, t, r, n, i) {
			let o = r === yx ? (0, $n.getIn)(i, ["config", "target", "objectId"]) : null;
	...
	var lh = s((Tj, ch) => {
		...
		function mM(e, t, r) {
			...
			var i = n - 1;
			return (
				r !== void 0 && ((i = IM(r)), (i = r < 0 ? TM(n + i, 0) : OM(i, n - 1))),
				gM(e, yM(t, 3), i, !0)
			);
		}
		ch.exports = mM;
	...
	var vh = s((Qn) => {
		...
		function wM(e, t) {
			...
			for (let i = 0; i < r.length; i++) if (!RM.call(t, r[i]) || !ph(e[r[i]], t[r[i]])) return !1;
			return !0;
		}
		var CM = wM;
		Qn.default = CM;
	...
	var Mh = s((re) => {
		...
		function Pa({ config: e, event: t, eventTarget: r, elementRoot: n, elementApi: i }) {
			var o, a, u;
			...
			if (Array.isArray(l) && l.length > 0)
				return l.reduce(
					(x, D) =>
						x.concat(
							Pa({ config: { target: D }, event: t, eventTarget: r, elementRoot: n, elementApi: i })
						),
					[]
				);
			let {
		...
		var Th = /px/,
			tD = (e, t) =>
				t.reduce((r, n) => (r[n.type] == null && (r[n.type] = lD[n.type]), r), e || {}),
			rD = (e, t) =>
				t.reduce(
					(r, n) => (r[n.type] == null && (r[n.type] = fD[n.type] || n.defaultValue || 0), r),
					e || {}
				);
		...
		function hD(e, t, r, n) {
			let i = (0, Ca.default)(t, (a, u, l) => (a.push(`"${l}" ${u}`), a), []).join(", "),
				{ setStyle: o } = n;
			wt(e, Xr, n), o(e, Xr, i);
		}
		...
		function mD(e, t, r, n, i, o) {
			...
			switch (n.actionTypeId) {
				case nr: {
					...
					f !== void 0 && (u === ht && (u = "px"), wt(e, Ze, o), a(e, Ze, f + u)),
						v !== void 0 && (l === ht && (l = "px"), wt(e, Je, o), a(e, Je, v + l));
					break;
				}
				case Br: {
					ED(e, r, n.config, o);
				...
				case ar: {
					let u = La[n.actionTypeId],
						...
						d = r.aValue;
					wt(e, u, o), a(e, u, d >= 1 ? `rgb(${l},${f},${v})` : `rgba(${l},${f},${v},${d})`);
					break;
				}
				default: {
					let { unit: u = "" } = n.config;
		...
		function SD(e, t, r) {
			...
			switch (t.actionTypeId) {
				case ti: {
					...
					i === VM && me.IS_BROWSER_ENV ? n(e, Jn, me.FLEX_PREFIXED) : n(e, Jn, i);
					return;
				}
			}
		}
		...
		function CD({ actionList: e, actionItemId: t, rawData: r }) {
			let { actionItemGroups: n, continuousParameterGroups: i } = e,
				o = [],
				a = (u) => (o.push((0, Eh.mergeIn)(u, ["config"], { delay: 0, duration: 0 })), u.id === t);
			return (
	...
	var Xh = s((ni) => {
		...
		var Dh = Re(),
			...
			{ optimizeFloat: ri, applyEasing: Gh, createBezierEasing: kD } = Fh.IX2EasingUtils,
			{ RENDER_GENERAL: zD } = Dh.IX2EngineConstants,
			{ getItemConfigByKey: Ma, getRenderType: YD, getStyleProp: $D } = Fh.IX2VanillaUtils,
			QD = (e, t) => {
				let {
						position: r,
						parameterId: n,
				...
				for (let G = 0, { length: X } = i; G < X; G++) {
					...
					if ((G === 0 && (g = W[0]), A >= Q)) {
						...
						let P = i[G + 1],
							_ = P && A !== Q;
						(C = _ ? P.actionItems[0] : null), _ && ((R = Q / 100), (N = (P.keyframe - Q) / 100));
					}
				}
				let M = {};
				if (g && !C)
			...
			ZD = (e, t) => {
				...
				d != null && (q = d), (O = E ?? O), a === zD ? (q = 0) : (o || b) && (q = O = 0);
				let { now: A } = t.payload;
				if (r && n) {
					let g = A - (i + O);
					if (u) {
				...
				switch (t.type) {
					...
					case WD: {
						...
						return (0, ur.set)(e, r, {
							...
							skipMotion: M,
							skipToValue: G,
							customEasingFn: Array.isArray(_) && _.length === 4 ? kD(_) : void 0,
						});
					}
					case HD: {
						let { instanceId: r, time: n } = t.payload;
						return (0, ur.mergeIn)(e, [r], { active: !0, complete: !1, start: n });
					}
					case jD: {
	...
	var Bh = s((Cj, Hr) => {
		...
		(Hr.exports = v2), (Hr.exports.__esModule = !0), (Hr.exports.default = Hr.exports);
	});
	var Hh = s((Nj, Wh) => {
		var E2 = dt(),
			h2 = he(),
	...
	var __ = s((Vj, h_) => {
		...
		function EF(e, t, r, n) {
			...
			for (var i = -1, o = t.length, a = o - 1, u = e; u != null && ++i < o; ) {
				...
				if (i != a) {
					var v = u[l];
					(f = n ? n(v, l, u) : void 0), f === void 0 && (f = E_(v) ? v : pF(t[i + 1]) ? [] : {});
				}
				fF(u, l, f), (u = u[l]);
			}
			return e;
	...
	var M_ = s((Yj, x_) => {
		...
		function u1(e) {
			...
			if (
				e1(e) &&
				(JF(e) || typeof e == "string" || typeof e.splice == "function" || t1(e) || n1(e) || ZF(e))
			)
				return !e.length;
			var t = QF(e);
	...
	var $_ = s((rK, Y_) => {
		...
		function q1(e, t, r) {
			...
			return (
				C1(r) && ((n = "leading" in r ? !!r.leading : n), (i = "trailing" in r ? !!r.trailing : i)),
	...
	var ai = s((z) => {
		...
		var iG = () => ({ type: F1 });
		z.sessionStopped = iG;
		var oG = ({ rawData: e, defer: t }) => ({ type: G1, payload: { defer: t, rawData: e } });
		...
		var uG = () => ({ type: U1 });
		z.clearRequested = uG;
		var cG = (e, t) => ({ type: B1, payload: { target: e, listenerParams: t } });
	...
	var tg = s((ge) => {
		...
		function CG({ id: e, selector: t }) {
			if (e) {
				...
				if (e.indexOf(J_) !== -1) {
					let n = e.split(J_),
						i = n[0];
					if (((r = n[1]), i !== document.documentElement.getAttribute(eg))) return null;
				}
		...
		function NG(e) {
			return e == null || e === document.documentElement.getAttribute(eg) ? document : null;
		}
		function qG(e, t) {
		...
		function FG(e) {
			return e != null && typeof e == "object" ? (e instanceof Element ? mG : SG) : null;
		}
	});
	var Ba = s((oK, ng) => {
		var GG = Qe(),
	...
	var dg = s((cK, fg) => {
		...
		function lg(e, t, r, n, i) {
			...
			for (r || (r = kG), i || (i = []); ++o < a; ) {
				var u = e[o];
				t > 0 && r(u) ? (t > 1 ? lg(u, t - 1, r, n, i) : KG(i, u)) : n || (i[i.length] = u);
			}
			return i;
		}
		fg.exports = lg;
	...
	var yg = s((dK, gg) => {
		...
		function ZG(e, t, r) {
			return (
				...
				function () {
					for (var n = arguments, i = -1, o = _g(n.length - t, 0), a = Array(o); ++i < o; )
						a[i] = n[t + i];
					i = -1;
	...
	var Ha = s((OK, Ug) => {
		...
		function TX(e) {
			for (var t = e.name + "", r = Vg[t], n = IX.call(Vg, t) ? r.length : 0; n--; ) {
				var i = r[n],
					o = i.func;
		...
		function $X(e) {
			return BX(function (t) {
				...
				for (n = a ? n : r; ++n < r; ) {
					...
					l && Jg(l[0]) && l[1] == (zX | KX | kX | YX) && !l[4].length && l[9] == 1
				...
				return function () {
					...
					for (var d = 0, E = r ? t[d].apply(this, f) : v; ++d < r; ) E = t[d].call(this, E);
					return E;
				};
			});
		}
	...
	var Ay = s((_i) => {
		...
		var Le = hi(Sr()),
			...
			LV = (e) => {
				...
				return NV(t.getBoundingClientRect(), { left: 0, top: l, right: n, bottom: i - l });
			},
			Sy = (e) => (t, r) => {
			...
			dy =
				...
				(t, r = {}) => {
					...
					let T = (v ? l : (o * (l || 0)) / 100) / d,
						...
						S,
						q = 0;
					r && ((b = E > r.percentTop), (S = r.scrollingDown !== b), (q = S ? E : r.anchorTop));
			...
			FV = {
					...
					handler: (
						...
						switch (a) {
							...
							case Nt.EventBasedOn.PAGE: {
								let { scrollLeft: C, scrollTop: R, scrollWidth: N, scrollHeight: M } = jr();
						...
						return (
							...
							(a !== Nt.EventBasedOn.ELEMENT || g || g !== o.elementHovered) &&
								((O = f ? 1 - O : O), e.dispatch((0, pi.parameterChanged)(A, O))),
				...
				[mV]: {
					...
					handler: (
						...
						if (v === Nt.EventBasedOn.VIEWPORT) {
							let C = g ? o / u : a / l;
							return (
								C !== i.scrollPercent && t.dispatch((0, pi.parameterChanged)(E, C)),
								{ scrollPercent: C }
							);
						} else {
							let C = cy(n, E),
							...
							return (
								_ !== i.scrollPercent && t.dispatch((0, pi.parameterChanged)(C, _)),
								{ scrollPercent: _ }
							);
						}
					},
				...
				[gy]: { types: "readystatechange IX2_PAGE_UPDATE", handler: Ue(Kr, MV(Ce)) },
				[yy]: { types: "readystatechange IX2_PAGE_UPDATE", handler: Ue(Kr, DV(Ce)) },
			};
		_i.default = FV;
	});
	var Qa = s((gt) => {
		...
		var XV = We(Sr()),
			...
			{ isPluginType: ts, createPluginInstance: rs, getPluginDuration: lU } = wy.IX2VanillaPlugins,
			Ry = navigator.userAgent,
			fU = Ry.match(/iPad/i) || Ry.match(/iPhone/),
			dU = 12;
		function pU(e) {
			qt({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: hU }),
				qt({ store: e, select: ({ ixRequest: t }) => t.playback, onChange: _U }),
		...
		function vU(e) {
			qt({
				...
				onChange: () => {
					Oi(e), Ny({ store: e, elementApi: pe }), Ti({ store: e, allowEvents: !0 }), qy();
				},
			});
		}
		function EU(e, t) {
		...
		function _U(e, t) {
			...
			if (
				...
				ns({ store: t, actionListId: n }), Py({ store: t, actionListId: n, eventId: o });
				let d = is({ store: t, eventId: o, actionListId: n, immediate: u, verbose: f });
				f && d && t.dispatch((0, ce.actionListPlaybackChanged)({ actionListId: n, isPlaying: !u }));
			}
		}
		...
		function Ti({ store: e, rawData: t, allowEvents: r, testManual: n }) {
			...
			t && e.dispatch((0, ce.rawDataImported)(t)),
				i.active ||
					...
					r && (AU(e), IU(), e.getState().ixSession.hasDefinedMediaQueries && vU(e)),
			...
			O.forEach((C) => {
				...
				N.forEach((M) => {
					...
					if (((S[W] = SU(S[W], R, M)), !b[W])) {
						b[W] = !0;
						let { config: P } = M;
						yi({ config: P, event: E, eventTarget: r, elementRoot: Q, elementApi: pe }).forEach(
							(_) => {
		...
		function RU(e) {
			...
			bU.forEach((r) => {
				window.addEventListener(r, t), e.dispatch((0, ce.eventListenerAdded)(window, [r, t]));
			}),
				t();
		}
		function Ly(e) {
		...
		function qU({ logic: e, store: t, events: r }) {
			...
			(0, zr.default)(u, (d, E) => {
				...
				uU(q, o.mediaQueryKeys) || t.dispatch((0, ce.mediaQueriesDefined)()),
					...
					(b.actionTypeId === Be.ActionTypeConsts.GENERAL_START_ACTION || Za(b.actionTypeId)) &&
			...
			let l = (d) => {
				...
				v = ({ target: d = document, types: E, throttle: T }) => {
					E.split(" ")
						...
						.forEach((b) => {
							let S = T ? f : l;
							d.addEventListener(b, S), t.dispatch((0, ce.eventListenerAdded)(d, [b, S]));
						});
				};
		...
		function LU(e) {
			...
			for (let n in e) {
				...
				t[a] ||
					((i === Be.EventTypeConsts.MOUSE_CLICK || i === Be.EventTypeConsts.MOUSE_SECOND_CLICK) &&
			...
			if (l && l.useFirstGroupAsInitialState) {
				...
				f.forEach((d) => {
					...
					let { config: T, actionTypeId: b } = d,
						S =
							(T == null || (E = T.target) === null || E === void 0 ? void 0 : E.useEventTarget) ===
							!0
		...
		function xy({ store: e }) {
			...
			(0, zr.default)(t, (r) => {
				if (!r.continuous) {
					...
					as(r, e),
						i && e.dispatch((0, ce.actionListPlaybackChanged)({ actionListId: n, isPlaying: !1 }));
				}
			});
		}
		function ns({ store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: i }) {
			...
			(0, zr.default)(o, (l) => {
				...
				if (l.actionListId === i && l.eventId === t && v) {
					...
					as(l, e),
						l.verbose &&
							e.dispatch((0, ce.actionListPlaybackChanged)({ actionListId: i, isPlaying: !1 }));
				}
			});
		}
		function is({
			...
			o >= S.length && (0, _t.default)(E, "config.loop") && (o = 0), o === 0 && q && o++;
			let A =
					(o === 0 || (o === 1 && q)) &&
			...
			return (
				g.forEach((M, G) => {
					...
					yi({ config: X, event: E, eventTarget: r, elementRoot: _, elementApi: pe }).forEach(
						(x, D) => {
		...
		function os(e) {
			...
			if (
				(r.dispatch(
					(0, ce.instanceAdded)(
						(0, XV.default)(
							{ instanceId: T, elementId: O, origin: N, refType: g, skipMotion: C, skipToValue: R },
							i
						)
					)
				),
		...
		function as(e, t) {
			My(document.body, "ix2-animation-stopping", { instanceId: e.id, state: t.getState() });
			...
			if (Ii(M, C.mediaQueryKey) && (n || r || i)) {
				...
				if (i) {
					if (S) {
						...
						O &&
							!G &&
							t.dispatch((0, ce.actionListPlaybackChanged)({ actionListId: b, isPlaying: !1 }));
					}
					as(e, t);
				}
			}
		...
		Si.define(
			...
			(jy.exports = function (e) {
					...
					switch (_) {
						...
						case "remove":
							(L = P.attr("data-wf-tabindex-swap")),
								L
									? (P.attr("tabindex", L), P.removeAttr("data-wf-tabindex-swap"))
				...
				function C(P) {
					...
					if (
						!(Si.env("design") || (window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(_.className)))
					) {
						var L = q(_) ? _.hash : "";
						if (L !== "") {
							var x = e(L);
							x.length &&
								...
								window.setTimeout(
									function () {
										N(x, function () {
											g(x, "add"), x.get(0).focus({ preventScroll: !0 }), g(x, "remove");
										});
									},
									P ? 0 : 300
								));
				...
				function N(P, _) {
					...
					if (L !== x) {
						var D = G(P, L, x),
							...
							K = function () {
								var ne = Date.now() - B;
								window.scroll(0, X(L, x, ne, D)), ne <= D ? u(K) : typeof _ == "function" && _();
							};
						u(K);
					}
				}
			...
			(ky.exports = function (e) {
				...
				function n(o) {
					...
					function d(q) {
						var O = q.touches;
						(O && O.length > 1) ||
							((a = !0), O ? ((u = !0), (f = O[0].clientX)) : (f = q.clientX), (v = f));
					}
					function E(q) {
						if (a) {
...
Webflow.require("ix2").init({
	events: {
		e: {
			...
			target: {
				id: "64825eb1384ca6d4faa665d0|b80235d8-75ba-ebdf-4438-003ff98ff9fa",
				appliesTo: "ELEMENT",
				styleBlockIds: [],
			},
			targets: [
		...
		"e-2": {
			...
			createdOn: 1515522631142,
		},
	},
	actionLists: {
		a: {
			id: "a",
			title: "scrolling interaction",
							...
							actionItems: [
								{
									...
									config: {
										...
										easing: "easeIn",
										duration: 500,
										target: { id: "64825eb1384ca6d4faa665d0|224ca3cb-5547-8c1e-021a-06abb5359668" },
										xValue: 1,
										yValue: 1,
										locked: true,
									},
								},
								{
									...
									config: {
										...
										easing: "ease",
										duration: 500,
										target: { id: "64825eb1384ca6d4faa665d0|f22da15e-7299-9aef-2854-82d5cfc5ab7b" },
										xValue: 1,
										yValue: 1,
										locked: true,
									},
							...
							actionItems: [
								...
								},
								{
									...
									config: {
										...
										duration: 500,
										target: { id: "64825eb1384ca6d4faa665d0|f22da15e-7299-9aef-2854-82d5cfc5ab7b" },
										filters: [{ type: "blur", filterId: "e292", value: 0, unit: "px" }],
									},
								},
								{
									id: "a-n-12",
							...
							actionItems: [
								...
								},
								{
									...
									config: {
										...
										duration: 500,
										target: { id: "64825eb1384ca6d4faa665d0|f22da15e-7299-9aef-2854-82d5cfc5ab7b" },
										filters: [{ type: "blur", filterId: "b4d4", value: 5, unit: "px" }],
									},
								},
								{
									id: "a-n-9",
			...
			createdOn: 1515521465269,
		},
		"a-4": {
			id: "a-4",
			title: "scrolling interaction 2",
			continuousParameterGroups: [
				{
					id: "a-4-p",
					type: "SCROLL_PROGRESS",
